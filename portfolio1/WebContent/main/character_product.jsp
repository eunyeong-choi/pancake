...
#menubar #right_table{ width : 700px; height : 600px; margin-right : 309px; float:right; text-align: center;}
...
<div id="menubar">
	...
	<div id="right_table" >
		<table style=" margin-left: 230px; margin-top: 20px;">
			<tr><td class="tt_td">팬케이크맛 쿠키 스티커</td></tr>
			<tr>
				<td class="tt_td">
					<img src="../img/스티커.jpg" height = 300px;>
				</td>
			</tr>
		</table>
	</div>
